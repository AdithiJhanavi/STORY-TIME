...
function sweetTooth(totalNoOfSweets,sweetCosumedByKaren,SweetsConsumedInNMeters,metersToTravel){
    var remaining = (totalNoOfSweets- (sweetCosumedByKaren+SweetsConsumedInNMeters*metersToTravel))/2;
    return remaining;
} 
